function [A11,A21,A31] = find_Coeffs_Ddl_Shoulder_Constant_HFD(alpha_Body,beta_Body,dalpha_Body,dbeta_Body,depth_Body,dgamma_Body,g,gamma_Body,height_Body,l_Beta_Hand,l_Tau_Alpha_Shoulder,m_Body,r_Beta_Hand,r_Tau_Alpha_Shoulder,width_Body)
%FIND_COEFFS_DDL_SHOULDER_CONSTANT_HFD
%    [A11,A21,A31] = FIND_COEFFS_DDL_SHOULDER_CONSTANT_HFD(ALPHA_BODY,BETA_BODY,DALPHA_BODY,DBETA_BODY,DEPTH_BODY,DGAMMA_BODY,G,GAMMA_BODY,HEIGHT_BODY,L_BETA_HAND,L_TAU_ALPHA_SHOULDER,M_BODY,R_BETA_HAND,R_TAU_ALPHA_SHOULDER,WIDTH_BODY)
