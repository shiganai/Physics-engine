...
createTask(job, @matlabFunction, 1,{X(1), X(2), ...
    'file', 'find_Dds_Arm_L_FFD.m', 'outputs', ...
...
createTask(job, @matlabFunction, 1,{...
    ...
    'file', 'find_Coeffs_Ddl_Arm_Bottom_FFD.m', 'outputs', ...
    {...
    'A11','A12','A13','A14',...
    'A21','A22','A23','A24',...
    'A31','A32','A33','A34',...
...
job = createJob(c);
createTask(job, @matlabFunction, 1,{X(1), X(2), ...
    'file', 'find_Dds_Arm_L_HFD.m', 'outputs', ...
...
createTask(job, @matlabFunction, 1,{...
    ...
    coeffs_Ddl_Arm_Bottom(2,1), coeffs_Ddl_Arm_Bottom(2,2), coeffs_Ddl_Arm_Bottom(2,3), coeffs_Ddl_Arm_Bottom(2,4), ...
    coeffs_Ddl_Arm_Bottom(3,1), coeffs_Ddl_Arm_Bottom(3,2), coeffs_Ddl_Arm_Bottom(3,3), coeffs_Ddl_Arm_Bottom(3,4), ...
    'file', 'find_Coeffs_Ddl_Arm_Bottom_HFD.m', 'outputs', ...
    {...
    'A11','A12','A13','A14',...
    'A21','A22','A23','A24',...
    'A31','A32','A33','A34',...
...
createTask(job, @matlabFunction, 1,{ddl_Arm_Bottom, ...
    'file', 'find_Ddl_Arm_Bottom_FRD.m', 'outputs', ...
    {'ddl_Arm_Bottom'}});
submit(job)
job.Tasks
...
createTask(job, @matlabFunction, 1,{dl_Arm_Bottom, ...
    'file', 'find_Dl_Arm_Bottom_FRD.m', 'outputs', ...
    {'dl_Arm_Bottom'}});
submit(job)
job.Tasks
...
createTask(job, @matlabFunction, 1,{l_Arm_Bottom, ...
    'file', 'find_L_Arm_Bottom_FRD.m', 'outputs', ...
    {'l_Arm_Bottom'}});
submit(job)
job.Tasks
