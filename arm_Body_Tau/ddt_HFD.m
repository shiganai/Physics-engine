function dotq = ddt_HFD(t,q,r_P_Fixed,l_P_Fixed, g, length_Hand, m_Hand, m_Body, width_Body, height_Body, depth_Body, l_Tau_Alpha_Shoulder, r_Tau_Alpha_Shoulder)
...
[A11,A12,A13,A14,A21,A22,A23,A24,A31,A32,A33,A34] = find_Coeffs_Ddl_Arlpha_Tau_Beta_Arm_L(ddl_Beta_Hand,dl_Beta_Hand,dl_Alpha_Hand,g,l_Alpha_Hand,l_Beta_Hand,l_Tau_Alpha_Shoulder,length_Hand,m_Hand);
...
[A11,A12,A13,A14,A15,A16,A17,A21,A22,A23,A24,A25,A26,A27,A31,A32,A33,A34,A35,A36,A37] = find_Coeffs_Ddr_Shoulder(alpha_Body,beta_Body,dalpha_Body,dbeta_Body,depth_Body,dgamma_Body,g,gamma_Body,height_Body,l_Tau_Beta_Shoulder,l_Tau_Alpha_Shoulder,m_Body,r_Tau_Beta_Shoulder,r_Tau_Alpha_Shoulder,width_Body);
coeffs_Ddr_Shoulder = [
...
[A11,A12,A13,A14,A15,A16,A17,A21,A22,A23,A24,A25,A26,A27,A31,A32,A33,A34,A35,A36,A37] = find_Coeffs_Ddl_Shoulder(alpha_Body,beta_Body,dalpha_Body,dbeta_Body,depth_Body,dgamma_Body,g,gamma_Body,height_Body,l_Tau_Beta_Shoulder,l_Tau_Alpha_Shoulder,m_Body,r_Tau_Beta_Shoulder,r_Tau_Alpha_Shoulder,width_Body);
coeffs_Ddl_Shoulder = [
    A11, A12, A13, A14, A15, A16, A17;
    A21, A22, A23, A24, A25, A26, A27;
    A31, A32, A33, A34, A35, A36, A37;
...
ddr_Alpha_Hand = find_Ddr_Arlpha_Tau_Beta_Arm_R(ddr_Beta_Hand,dr_Beta_Hand,dr_Alpha_Hand,g,length_Hand,m_Hand,r_Alpha_Hand,r_Beta_Hand,r_F_X,r_F_Y,r_F_Z,r_Tau_Alpha_Shoulder);
ddl_Alpha_Hand = find_Ddl_Arlpha_Tau_Beta_Arm_L(ddl_Beta_Hand,dl_Beta_Hand,dl_Alpha_Hand,g,l_Alpha_Hand,l_Beta_Hand,l_F_X,l_F_Y,l_F_Z,l_Tau_Alpha_Shoulder,length_Hand,m_Hand);
[ddalpha_Body,ddbeta_Body,ddgamma_Body,ddx_Head,ddy_Head,ddz_Head] = find_Dds_Body(alpha_Body,beta_Body,dalpha_Body,depth_Body,dgamma_Body,g,gamma_Body,height_Body,l_F_X,l_F_Y,l_F_Z,l_Tau_Beta_Shoulder,l_Tau_Alpha_Shoulder,m_Body,r_F_X,r_F_Y,r_F_Z,r_Tau_Beta_Shoulder,r_Tau_Alpha_Shoulder,width_Body);
