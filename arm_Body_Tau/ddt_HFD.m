...
ddr_Beta_Hand = -2 * dr_Beta_Hand - r_Beta_Hand;
ddl_Beta_Hand = -2 * dl_Beta_Hand - l_Beta_Hand;
...
%%
coeffs_Matrix_Force = [
    coeffs_Ddr_Arm_Bottom_Force - coeffs_Ddr_Shoulder_Force;
    coeffs_Ddl_Arm_Bottom_Force - coeffs_Ddl_Shoulder_Force;
    ] + [
    coeffs_Ddr_Shoulder_Tau_Beta;
    coeffs_Ddl_Shoulder_Tau_Beta;
    ] * [
    coeffs_R_Tau_Beta_Shoulder_Force;
    coeffs_L_Tau_Beta_Shoulder_Force;
    ];

coeffs_Target = [
    coeffs_Ddl_Arm_Bottom_Constant - coeffs_Ddl_Shoulder_Constant;
    coeffs_Ddr_Arm_Bottom_Constant - coeffs_Ddr_Shoulder_Constant;
    ];
