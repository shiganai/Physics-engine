function ddr_Shoulder = find_Ddr_Shoulder_FRD(alpha_Body,beta_Body,dalpha_Body,dbeta_Body,ddalpha_Body,ddbeta_Body,ddgamma_Body,ddx_Head,ddy_Head,ddz_Head,dgamma_Body,gamma_Body,width_Body)
%FIND_DDR_SHOULDER_FRD
%    DDR_SHOULDER = FIND_DDR_SHOULDER_FRD(ALPHA_BODY,BETA_BODY,DALPHA_BODY,DBETA_BODY,DDALPHA_BODY,DDBETA_BODY,DDGAMMA_BODY,DDX_HEAD,DDY_HEAD,DDZ_HEAD,DGAMMA_BODY,GAMMA_BODY,WIDTH_BODY)
