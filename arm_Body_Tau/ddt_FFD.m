function dotq = ddt(t,q,r_P_Fixed,l_P_Fixed, g, length_Hand, m_Hand, m_Body, width_Body, height_Body, depth_Body, l_Tau_Alpha_Shoulder, r_Tau_Alpha_Shoulder)
...
coeffs_Ddr_Arm_Bottom = find_Coeffs_Ddr_Arm_Bottom(dr_Beta_Hand,dr_Alpha_Hand,g,length_Hand,m_Hand,r_Alpha_Hand,r_Beta_Hand,r_Tau_Alpha_Shoulder);
coeffs_Ddr_Arm_Bottom = [coeffs_Ddr_Arm_Bottom(:, 1:3), zeros(3,3), coeffs_Ddr_Arm_Bottom(:, 4)];

coeffs_Ddl_Arm_Bottom = find_Coeffs_Ddl_Arm_Bottom(dl_Beta_Hand,dl_Alpha_Hand,g,l_Alpha_Hand,l_Beta_Hand,l_Tau_Alpha_Shoulder,length_Hand,m_Hand);
coeffs_Ddl_Arm_Bottom = [zeros(3,3), coeffs_Ddl_Arm_Bottom(:, 1:3), coeffs_Ddl_Arm_Bottom(:, 4)];

coeffs_Ddr_Shoulder = find_Coeffs_Ddr_Shoulder(alpha_Body,beta_Body,dalpha_Body,dbeta_Body,depth_Body,dgamma_Body,g,gamma_Body,height_Body,l_Tau_Alpha_Shoulder,m_Body,r_Tau_Alpha_Shoulder,width_Body);
...
[ddr_Alpha_Hand,ddr_Beta_Hand] = find_Dds_Arm_R(dr_Beta_Hand,dr_Alpha_Hand,g,length_Hand,m_Hand,r_Alpha_Hand,r_Beta_Hand,r_F_X,r_F_Y,r_F_Z,r_Tau_Alpha_Shoulder);
[ddl_Alpha_Hand,ddl_Beta_Hand] = find_Dds_Arm_L(dl_Beta_Hand,dl_Alpha_Hand,g,l_Alpha_Hand,l_Beta_Hand,l_F_X,l_F_Y,l_F_Z,l_Tau_Alpha_Shoulder,length_Hand,m_Hand);
