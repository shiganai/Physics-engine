function [A11,A21,A31] = HFD_Coeffs_Ddl_Shoulder_Constant(alpha_Body,beta_Body,dalpha_Body,dbeta_Body,depth_Body,dgamma_Body,g,gamma_Body,height_Body,l_Beta_Hand,l_Tau_Alpha_Shoulder,m_Body,r_Beta_Hand,r_Tau_Alpha_Shoulder,width_Body)
...
t98 = t78+t87+t92+t96;
A11 = (t3.*t4.*t14.*width_Body)./2.0+(t3.*t4.*t16.*width_Body)./2.0-(t3.*t9.*t98.*width_Body)./2.0-(height_Body.*t9.*t16.*t48.*(t38+t17.*t22.*3.0))./2.0-dbeta_Body.*dgamma_Body.*t8.*t9.*width_Body-height_Body.*t4.*t29.*t48.*t95.*6.0-t4.*t8.*t62.*t81.*width_Body.*6.0+t2.*t4.*t9.*t17.*t48.*t82.*(3.0./4.0)+t4.*t6.*t9.*t17.*t29.*t48.*t84.*3.0;
if nargout > 1
