function [ddr_Alpha_Hand,r_Tau_Beta_Shoulder] = find_Dds_Arm_R_HFD(ddr_Beta_Hand,dr_Beta_Hand,dr_Alpha_Hand,g,length_Hand,m_Hand,r_Alpha_Hand,r_Beta_Hand,r_F_X,r_F_Y,r_F_Z,r_Tau_Alpha_Shoulder)
%FIND_DDS_ARM_R_HFD
%    [DDR_ALPHA_HAND,R_TAU_BETA_SHOULDER] = FIND_DDS_ARM_R_HFD(DDR_BETA_HAND,DR_BETA_HAND,DR_ALPHA_HAND,G,LENGTH_HAND,M_HAND,R_ALPHA_HAND,R_BETA_HAND,R_F_X,R_F_Y,R_F_Z,R_TAU_ALPHA_SHOULDER)
